...
stocks = r'C:\Users\fukam\iCloudDrive\プログラミング\爆上げ銘柄管理君\銘柄データ収集\stocks.db'
...
def insert_brands_to_db(stocks,code_range):
  ...
  with conn:
    sql = 'INSERT INTO stocks(code, name, sector, date, start_price, closing_price, high_price, low_price, MA25, volume) ' \
          'VALUES(?,?,?,?,?,?,?,?,?,?)'
